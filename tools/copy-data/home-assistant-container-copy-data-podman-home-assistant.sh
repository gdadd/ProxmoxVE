...
# Use to copy all data from a Home Assistant LXC to a Podman Home Assistant LXC
# run from the Proxmox Shell
<<<<<<< HEAD:misc/copy-data/home-assistant-container-copy-data-podman-home-assistant.sh
...
>>>>>>> upstream/main:tools/copy-data/home-assistant-container-copy-data-podman-home-assistant.sh
