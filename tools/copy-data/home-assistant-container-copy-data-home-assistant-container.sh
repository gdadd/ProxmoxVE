...
# Use to copy all data from one Home Assistant LXC to another
# run from the Proxmox Shell
<<<<<<< HEAD:misc/copy-data/home-assistant-container-copy-data-home-assistant-container.sh
...
>>>>>>> upstream/main:tools/copy-data/home-assistant-container-copy-data-home-assistant-container.sh
